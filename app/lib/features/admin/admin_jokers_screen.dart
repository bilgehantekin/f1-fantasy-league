...
class _RaceJokerTile extends ConsumerWidget {
  ...
  Future<void> _editDialog(
    ...
    final pointsCtrl =
        TextEditingController(text: '${existing?.points ?? 12}');
          ...
          child: Column(
            ...
            children: [
              TextField(
                controller: textCtrl,
                decoration:
                    const InputDecoration(labelText: 'Soru metni'),
                maxLines: 2,
              ),
              TextField(
                controller: optsCtrl,
    ...
    try {
      await upsertJoker(
        ...
        options: optsCtrl.text
            ...
            .toList(),
        correct: correctCtrl.text.trim().isEmpty ? null : correctCtrl.text.trim(),
