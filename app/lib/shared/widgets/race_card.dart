...
class RaceCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final (statusLabel, statusColor) = switch (race.status) {
      RaceStatus.upcoming when race.isLocked => ('KİLİTLİ', AppColors.lockOrange),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(fmt.format(race.raceAt.toLocal()).toUpperCase(),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(timeFmt.format(race.raceAt.toLocal()),
                            style: tt.labelSmall
